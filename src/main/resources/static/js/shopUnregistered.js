...
function updateTotals() {
    ...
    $('#korpatotal').text(suma + " RSD");
    $('#totalkilaza').text((kilaza) + " kg");
    postarina = 0;
    if (kilaza <= 0.5) {
        postarina = 300;
    }
...
function napraviKorpaStavke() {
    ...
    for (var i = 0; i < celaKorpa.length; i++) {
        ...
        var stavka = " <div class=\"row border-top border-bottom stavkaJS korpaStavkeSmallerScreen\" pid=\"" + celaKorpa[i].idProizvoda + "\">"
                ...
                + " <div class=\"col-4 slikaStavkaSmallerScreen\"><img class=\"img-fluid slika-korpaStavka slika-korpaStavkaSmallerScreen\"  src=\"/photo/" + celaKorpa[i].idProizvoda + "/" + celaKorpa[i].photoId + "\"></div>"
